    ...
    @section('content_header')
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Residencias</h4>
                <div class="">
                    <a href="{{ route('clientes.index') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Volver</a>
    ...
    <div class="modal fade" id="modalResidencia" tabindex="-1" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div
                    class="modal-header @switch($mode) @case('create') bg-primary @break @case('edit') bg-info @break @case('view') bg-warning @endswitch
                    ">
