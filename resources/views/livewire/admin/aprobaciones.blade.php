<div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-primary text-white">
            <h3 class="card-title">Listado de Residencias sin aprobación</h3>
        </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <button wire:click="revisar({{ $residencia->id }})" class="btn btn-sm btn-info">
                                    Revisar <i class="fas fa-search"></i>
                                </button>
                            </td>
                        </tr>
                    @empty
    ...
    <div class="card mt-3">
        <div class="card-header bg-success">
            <h3 class="card-title">Historial de Residencias VERIFICADAS</h3>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($propietario->residencias->where('estado', 'VERIFICADO') as $verificado)
                            <tr class="text-center">
                                ...
                                <td><span class="badge bg-success">{{ $verificado->estado }}</span></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary" wire:click="cerrarModal"><i class="fas fa-ban"></i>
                            Cerrar</button>
