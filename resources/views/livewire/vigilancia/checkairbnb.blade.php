        ...
        <div class="container">
            <div class="header-navigation">
                ...
                <div class="header-title">
                    <h1 class="title-text">VALIDACIONES AIRBNB</h1>
                    <p class="subtitle-text">Sistema de verificación de reservas</p>
                </div>
...
@section('js')
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            ...
            Livewire.on('copiarTexto', (event) => {
                const texto = event.texto || event[0];
