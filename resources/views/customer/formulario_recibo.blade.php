...
@php
    ...
    $mescobro = explode('-', $citerecibo->mescobro);
...
<head>
    ...
    <title>Formulario de Registro Recibo</title>
...
<body>
    <div class="container">
        <div class="alert alert-success text-center mt-4" role="alert">
            <h3>FORMULARIO NRO.:{{ cerosIzq($citerecibo->id) }} CORRECTAMENTE VALIDADO!</h3>
        </div>
        <div class="form-container">
            <h4 class="text-secondary text-center"><strong>Formulario de Recibo </strong></h4>
            <h5 class="text-secondary text-center">{{ $citerecibo->cliente_data->nombre }}</h5>
                ...
                <table class="table table-hover table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $citerecibo->cliente_data->personacontacto }}</td>
                        </tr>
                        <tr>
                            <td><strong>DETALLES:</strong></td>
                            <td>
                                Mediante la presente certifico el pago por los servicios prestados de la empresa de
                                seguridad Black Bird
                                correspondientes al mes de {{ $meses[$mescobro[0]] }}-{{ $mescobro[1] }} en
                                instalaciones del
                                mencionado
                                establecimiento.
                            </td>
