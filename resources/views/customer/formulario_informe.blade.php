...
<body>
    <div class="container">
        <div class="alert alert-success text-center mt-4" role="alert">
            <h3>FORMULARIO NRO.:{{ cerosIzq($citeinforme->id) }} CORRECTAMENTE VALIDADO!</h3>
        </div>
        <div class="form-container">
            <h4 class="text-secondary text-center"><strong>REGISTRO DE INFORME </strong></h4>
            <h5 class="text-secondary text-center">{{ $citeinforme->cliente_data->nombre }}</h5>
                ...
                <table class="table table-hover table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $citeinforme->fechaliteral }}</td>
                        </tr>
                        <tr>
                            <td><strong>DIRIGIDO A:</strong></td>
                            <td>{{ $citeinforme->representante }}</td>
                        </tr>
                        <tr>
